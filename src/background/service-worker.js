...
const DEFAULT_STATE = {
  enabled: true,
  // Ordered so HbbTV vendor feature detectors match: the HbbTV/x.y.z (...)
  // token must appear BEFORE the trailing Chrome/WebKit token, as vendor
  // detection regexes expect.
